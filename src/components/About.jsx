  ...
  return (
    ...
    <ul>
      ...
      <li>
        ...
        Govt. Excellence Higher Secondary School, Anuppur<br></br>
    ...
    <ul>
      <li>Completed a certification in Core Java Programming with distinction.</li>
      <li>Recognized as the "Best Problem Solver" in a coding competition at college.</li>
      <li>Developed a mini project on an e-commerce website using Spring Boot and React.js.</li>
      <li>Achieved consistent performance in academic coursework related to software development.</li>
    </ul>
  </section>
        </span>
        <br />
